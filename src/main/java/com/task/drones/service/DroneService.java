...
public interface DroneService {
     ...
     * @param droneRequest new drone request
     * @return created drone
     */
    Drone create(DroneRegistrationRequest droneRequest);

    /**
     * Save medications to load them on the drone.
     * @param droneId id of loaded drone
     * @param medications medications to load
     ...
     */
    Drone load(Integer droneId, List<Medication> medications, boolean isFinalLoad)
